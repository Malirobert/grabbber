...
# Créer un dossier permanent pour les téléchargements de manière compatible avec tous les OS
DOWNLOAD_FOLDER = Path.home() / "Videos" / "Grabber"
        ...
        with TemporaryDirectory() as temp_path:
            ...
            with yt_dlp.YoutubeDL(temp_opts) as ydl:
                try:
                    ...
                    if info:
                        temp_video_path = temp_path / f"{info['title']}.{info['ext']}"
                        final_video_path = DOWNLOAD_FOLDER / f"{info['title']}.{info['ext']}"
